...
|----------|-------------|--------------|-------|
| **Grok** (X.com) | `BOSSMAN_LBOS_v4.1_COLD_START.txt` | ~95% | Most permissive, handles full spec |
| **Claude** (claude.ai) | `BOSSMAN_v4.2_MINIMAL.txt` | ~90% | Use minimal version, Claude detects simulation language |
| **GPT-5** (ChatGPT) | `BOSSMAN_LBOS_v4.1_GPT_FINAL.txt` | ~85% | GPT-5 optimized variant |
| **Gemini** | `BOSSMAN_v4.2_MINIMAL.txt` | ~75% | Start with minimal, may require retry |
| **Others** | `BOSSMAN_v4.2_MINIMAL.txt` | ~70% | Try minimal first, cold-start if accepted |
...
- Grok users → `BOSSMAN_LBOS_v4.1_COLD_START.txt`
- Claude users → `BOSSMAN_v4.2_MINIMAL.txt`  
- GPT-5 users → `BOSSMAN_LBOS_v4.1_GPT_FINAL.txt`
- Unsure? → Start with `BOSSMAN_v4.2_MINIMAL.txt`
...
```
/specs/
  ├── BOSSMAN_LBOS_v4.1_COLD_START.txt    # For Grok (full features)
  ├── BOSSMAN_v4.2_MINIMAL.txt            # For Claude/Gemini (streamlined)
  ├── BOSSMAN_LBOS_v4.1_GPT_FINAL.txt     # For GPT-5 (optimized)
...
🚀 **Grok Users**: Copy `/specs/BOSSMAN_LBOS_v4.1_COLD_START.txt`  
🚀 **Claude Users**: Copy `/specs/BOSSMAN_v4.2_MINIMAL.txt`  
🚀 **GPT-5 Users**: Copy `/specs/BOSSMAN_LBOS_v4.1_GPT_FINAL.txt`  
